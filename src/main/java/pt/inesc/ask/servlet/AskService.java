...
public class AskService {
        ...
        for (String answerId : quest.getAnswersIDs()) {
            try {
                ...
                for (String commentId : answer.getCommentsIds()) {
                    // LOG.info("Delete comment: " + commentId + " of question: " +
                    // questionTitle + " using srd:" + srd);
                    c = c && dao.deleteComment(commentId, srd);
                }
                // LOG.info("Delete answer: " + answerId + " of question: " +
                // questionTitle + " using srd:" + srd);
    ...
    public boolean deleteAnswer(String questionTitle, String answerId, SRD srd) throws AskException {
        ...
        // Delete all comments
        for (String commentId : answer.getCommentsIds()) {
            // LOG.info("Delete comment: " + commentId + " of question: " + questionTitle
            // + " using srd:" + srd);
            c = c && dao.deleteComment(commentId, srd);
        }
