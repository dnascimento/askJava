...
public class AskService {
    ...
    public void newQuestion(String title, String text, List<String> tags, String author, String rid) {
    ...
    public Map<String, Object> getQuestionData(String questionTitle, String rid) throws AskException {
    ...
    public void deleteQuestion(String questionTitle, String rid) throws AskException {
    ...
    public void newAnswer(String questionTitle, String author, String text, String rid) throws AskException {
    ...
    public void updateAnswer(String answerId, String text, String rid) throws AskException {
    ...
    public void deleteAnswer(String questionTitle, String answerId, String rid) throws AskException {
    ...
    public void newComment(String questionTitle, String answerID, String text, String author, String rid) throws AskException {
    ...
    public void updateComment(String questionTitle, String answerID, String commentID, String text, String rid) throws AskException {
    ...
    public void deleteComment(String commentID, String answerID, String rid) throws AskException {
    ...
    public void voteUp(String questionTitle, String answerId, String rid) throws AskException {
    ...
    public void voteDown(String questionTitle, String answerId, String rid) throws AskException {
